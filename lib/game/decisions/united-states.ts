// lib/game/decisions/united-states.ts
// United States decision catalog for the Iran 2026 scenario.
// Source: docs/Iran Research/research-{military,political,economic}.md
import type { DecisionOption, DecisionDetail } from '@/lib/types/panels'

export const US_DECISIONS: DecisionOption[] = [
  {
...
export const US_DECISION_DETAILS: Record<string, DecisionDetail> = {
  'expand-air': {
