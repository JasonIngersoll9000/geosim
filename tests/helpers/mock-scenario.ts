...
export function createMockDecisions(actorId: string): Decision[] {
  ...
  return [
    ...
    },
    {
      ...base,
      id: "dec-ground-op",
      name: "Launch coastal ground operation",
    ...
    },
    {
      ...base,
      id: "dec-sanctions",
      name: "Tighten sanctions on Iranian allies",
    ...
    },
    {
      ...base,
      id: "dec-ceasefire",
      name: "Propose ceasefire via backchannel",
    ...
    },
    {
      ...base,
      id: "dec-intel-op",
      name: "Covert intelligence operation",
